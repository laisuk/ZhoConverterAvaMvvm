...
public class LanguageSettingsService
{
    ...
    private LanguageSettings ReadLanguageSettingsFromJson(string filePath)
    {
        ...
        // Otherwise, restore default JSON contents
